...
import { Store, Zap, Clock, ArrowRight, Star, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-b from-white to-indigo-50/50">
      ...
      <div className="relative isolate px-6">
        <div className="mx-auto max-w-4xl py-20 sm:py-32 lg:py-48 space-y-16 animate-fade-in-up">
          <div className="text-center space-y-8">
            ...
            <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-6">
              <Link
                href="/menu"
                className="w-full sm:w-auto px-12 py-6 bg-indigo-600 text-white rounded-[2rem] font-black text-xl shadow-2xl shadow-indigo-100 hover:bg-indigo-700 hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-3 border-b-4 border-indigo-900"
              >
                Start Ordering 🍔
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-10">
            <div className="glass-card p-8 rounded-[2.5rem] shadow-xl border border-white space-y-4 hover:scale-105 transition-transform group">
              <div className="p-4 bg-amber-100 rounded-2xl w-fit group-hover:rotate-12 transition-transform">
                <Zap className="w-8 h-8 text-amber-600" />
              </div>
              <h3 className="text-xl font-black text-gray-900">Lightning Fast</h3>
              <p className="text-gray-500 font-bold text-sm leading-relaxed">Pre-order in seconds and have your meal ready when you arrive.</p>
            </div>

            <div className="glass-card p-8 rounded-[2.5rem] shadow-xl border border-white space-y-4 hover:scale-105 transition-transform group">
              <div className="p-4 bg-indigo-100 rounded-2xl w-fit group-hover:rotate-12 transition-transform">
                <Clock className="w-8 h-8 text-indigo-600" />
              </div>
              <h3 className="text-xl font-black text-gray-900">Smart Prediction</h3>
              <p className="text-gray-500 font-bold text-sm leading-relaxed">AI-powered pickup estimates so you never wait a second too long.</p>
            </div>

            <div className="glass-card p-8 rounded-[2.5rem] shadow-xl border border-white space-y-4 hover:scale-105 transition-transform group">
              <div className="p-4 bg-emerald-100 rounded-2xl w-fit group-hover:rotate-12 transition-transform">
                <Store className="w-8 h-8 text-emerald-600" />
              </div>
              <h3 className="text-xl font-black text-gray-900">Vendor Direct</h3>
              <p className="text-gray-500 font-bold text-sm leading-relaxed">Order directly from your favorite campus stalls with real-time updates.</p>
            </div>
          </div>
        </div>
      </div>
